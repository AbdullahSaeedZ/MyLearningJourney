...
public:
	...
	static int ReadNumInRange(int From, int To, string ErrorMessage = "Number is not within range, Enter again:\n")
	{
	...
	static double ReadDblNumberInRange(double From, double To, string ErrorMessage = "Number is not within range, Enter again:\n")
	{
