...
enum enQuestionLevel { EasyLeve = 1, MedLeve = 2, HardLevel = 3, Mix = 4 };
...
enQuestionLevel ReadQuestionsLevel()
{
	...
	do
	{
		cout << "Enter Question Level [1] Easy, [2] Mix, [3] Hard, [4] Mix ? ";
		cin >> QuestionLevel;
...
void AskAndCorrectQuestionListAnswers(sQuizz& Quizz)
{
	...
	/*
	if (Quizz.NumberOfRightAnswer >= Quizz.NumberOfWrongAnswers)
		Quizz.isPass = true;
	else
		Quizz.isPass = false;
	*/
