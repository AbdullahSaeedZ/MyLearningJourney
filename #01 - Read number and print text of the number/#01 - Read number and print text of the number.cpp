...
string NumberToText(int Number)
{
    ...
    { 
        return   NumberToText(Number / 1000000000) + "Billions " + NumberToText(Number % 1000000000); // wrong results will come up due to int data type, declare as long long and will work
    }
}
